...
function create_player() {
    return Crafty.e('2D, Canvas, Persist, Twoway, Gravity, Collision, Motion, SpriteAnimation, ' + Setting.player.name_component)
        ...
        .bind('UpdateFrame', function () {
            if (!Crafty(BossFight.name_component).get(0)){
                if (this.x+this.w<0)
